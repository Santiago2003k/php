    ...
    <nav class="navbar bg-dark">
      ...
      <section  class="container-fluid mb-2">
        <div class="ratio ratio-16x9">
            <video src="school.mp4" autoplay loop muted></video>
          </div>
      </section>
      <section class="container-fluid bg-dark d-flex justify-content-center">
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <img class="mt-4 mb-4" src="OIP (1).jpg" alt="" style="border-radius: 50%; height: 16em;">
                </div>
                <div class="cards row d-flex justify-content-center">
                    <div class="card col-sm-12 col-4 mx-1 mb-2" style="width: 18rem;">
      ...
      <footer style="height:1em;">
        <p class="text-center">
        Allianza Colegio © SG 2024
      </p></footer>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
</body>
</html>