...
<section class="container">
    <div class="registration-form ">
        <form action="insert-m.php" method="POST">
            <div class="form-icon">
                <span><i class="icon icon-user"></i></span>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" name="Nombre"  placeholder="Nombre profesor">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" name="materia" placeholder="Materia encargada">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" name="grupo" placeholder="Salon a dar la materia">
            </div>
            <div class="form-group">
